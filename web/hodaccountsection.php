...
<center><h2><i class="fa fa-tasks"></i><u>Accounts Detail of Students</u></h2></center>
<h3>Year 2:</h3>
<?php
...
$sql="SELECT * FROM `studentfeespayment` where year=2 ";
    ...
    echo "<br>SubmissionID: " . $row["submissionID"]. "<br> Year:  " . $row["year"]. " Reciept
    " . $row["Reciept"]."<br>StudentName".$row['StudentName']."StudentEmail".$row['StudentEmail']."ConfirmyourMobilenumber".$row['ConfirmyourMobilenumber']. "<br>";
    }
} else {
    echo "0 results";
}
...
$sql="SELECT * FROM `studentfeespayment` where year=3 ";
...
$sql="SELECT * FROM `studentfeespayment` where year=4 ";
