...
<center><h2><i class="fa fa-th"></i>Upload Results </h2></center>

<div class="result">
    <form method="POST" action="hodresultdb.php" enctype="multipart/form-data">
        <table>
            <tr>
                <td>Name: <input type="text" name="result_faculty_name" placeholder="Enter your name.."></td>
                <td>Sem: <select name="sem_number">
                    <option value="one">First</option>
                    <option value="two">Second</option>
                    <option value="three">Third</option>
                    <option value="four">Fouth</option>
                ...
                <td>Type: <select name="sem_type">
                    <option value="Sessional">Sessional</option>
                    <option value="Semester">Semester</option>
                </select></td>
                <td>Year: <select name="sem_year">
                    <option value="two">Second</option>
                    <option value="three">Third</option>
                    <option value="four">Fouth</option>
                </select></td>
            ...
            <tr>
                <td colspan="4">
                    Comment: <input type="text" name="file_comment">
                </td>
            </tr>
            <tr>
                <td colspan="4">
