...
<center><h1><i class="fa fa-bullhorn"></i><u> News and Events</u></h1></center>  
...
$sql="SELECT * FROM `hodnewsedit` ORDER by nu DESC";
    ...
    echo "Serial: " . $row["nu"]. "<br> Name:  " . $row["name"]. " Date
    " . $row["date"]."<br>".$row['textarea']. "<br><hr>";
    }
} else {
    echo "0 results";
}
