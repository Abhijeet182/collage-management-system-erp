...
<div class="news_hod_edit">
<form action="hodnewseditdb.php" method="post">
    ...
    <table border="0">
        <tr>
            <td>
    Name:<input type="text" name="news_edit_name">
</td>
    <br>
    <td>
    Date:<input type="date" name="news_edit_date">
</td>
<td>
    Concerned:
    <select name="news_edit_option">
...
<br>
<textarea name="textarea" rows="10" cols="65"></textarea><br>
<INPUT TYPE="SUBMIT"  NAME="B1" style="display:block; margin: 0 auto;">
<br>
</form>
</div>
