...
<!DOCTYPE html>
<head>
<title>Welcome to Faculty Panel</title>
...

{
          ...
          $sql="select full_name from addfaculty where type='Faculty' and username='". $username."'";
       // echo "$sql";
...
<br/><font face="verdana" size="5" color="blue">Your personal details are here below::-</font>
...
<?php
        ...
        if(   isset($_COOKIE["username1"]))
         ...
         $sql="select * from addfaculty where username='". $username."'";
       // echo "$sql";
       $query = mysqli_query($db , $sql);
...
<br/><hr><font face="verdana" size="5" color="blue">Your Department details are here below::-</font>
<br>Coming Soon........
<br>
<br>
