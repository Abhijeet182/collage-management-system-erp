...
<?php
        ...
        if(   isset($_COOKIE["username1"]))
         ...
         $sql="select * from addstudent where username='". $username."'";
       // echo "$sql";
       $query = mysqli_query($db , $sql);
...
<div>
    <br><center>
    <form action="Student_Fees_payment.php" method="GET">

              Submit your fees<select   name='category'>
                <option class='drop-down' value='student'> Select your year for fees </option>
                    <option class='drop-down' value='student'> 1 Year </option>            
                    <option class='drop-down' value='Faculty'> 2 Year</option>            
                    <option class='drop-down' value='HOD'> 3 Year </option>            
                    <option class='drop-down' value='administration'> 4 Year </option>          
                </select>
               <br><br>
               <img src="https://www.paypalobjects.com/webstatic/en_US/i/buttons/cc-badges-ppmcvdam.png" alt="Buy now with PayPal" />
               <br> <br><button < a href="Student_Fees_payment" class="button"><span>Checkout for payment</span></button>
               </center><br>
          </div>
